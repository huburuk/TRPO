...
<!--			</li>-->
			<li class="sidebar__nav-item">
				<a href="./" class="sidebar__nav-link"><i class="side_icon feather icon-grid"></i> <span>Catalog</span></a>
			</li>
<!--			<li class="sidebar__nav-item">-->
									...
									<div class="col-12 col-sm-6 col-lg-3">
										<div class="form__group">
											...
											<select name="plan_type" required class="js-example-basic-single" id="quality">
												<option <?php if ($item_plan == "Free") {
															print ' selected ';
														} ?> value="Free">Free Plan
												</option>
												<option <?php if ($item_plan == "Paid") {
															print ' selected ';
														} ?> value="Paid">Paid Plan
												</option>
											</select>
										</div>
									</div>
									...
									<div class="col-12 col-lg-12">
										<div class="form__group">
											...
											<select class="js-example-basic-multiple" name="genre" required id="genre" multiple="multiple">
												...
												?>
															<option selected value="<?php echo $row[1]; ?>"><?php echo $row[1]; ?>
															</option><?php
																	} else {
																		?>
