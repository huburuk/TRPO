					...
					<div class="profile__content">
						<div class="profile__user">
							...
							<div class="profile__meta profile__meta--<?php echo $color; ?>">
								<h3><?php echo $u_username; ?>
									<?php if ($u_badge == "1") {
										print '<img title="Verified Account" id="verified" class="verification_inside" src="../img/check.svg">';
									} ?>
									<span>(<?php echo $plan_name; ?>)</span>
								</h3>
								<span>FlixTV ID: <?php echo $user; ?>
								</span>
							</div>
						</div>
						...
						<div class="profile__actions">
							<a href="#modal-status3" class="profile__action profile__action--<?php if ($u_status == "1") {
																									print 'view';
																								} else {
																									print 'banned';
																								} ?> open-modal"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
							...
							<a href="#modal-delete3" class="profile__action profile__action--delete open-modal"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
												...
												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													<div class="sign__group">
														...
														<select name="verification" required class="js-example-basic-single" id="rights">
															<option <?php if ($u_badge == "1") {
																		print ' selected ';
																	} ?> value="1">Verified Account
															</option>
															<option <?php if ($u_badge == "0") {
																		print ' selected ';
																	} ?> value="0">Unverified Account
															</option>
														</select>
													</div>
												</div>
									...
									<tbody>
										...
										?>
												<tr>
													...
													<td>
														<div class="main__table-text"><?php echo $row[28]; ?>
															<?php if ($row[34] == "1") {
																print '<img title="Verified Account" id="verified" class="verification_inside" src="../img/check.svg">';
															} ?>
														</div>
													...
													<div id="modal-view<?php echo $row[0]; ?>" class="zoom-anim-dialog mfp-hide modal modal--view">
														<div class="reviews__autor">
															...
															<span class="comments__name"><?php echo $row[25]; ?>
																<?php echo $row[26]; ?> <?php if ($row[34] == "1") {
																							print '<img title="Verified Account" id="verified" class="verification_inside" src="../img/check.svg">';
																						} ?>
															</span>
									...
									<tbody>
										...
										?>
												<tr>
													...
													<td>
														<div class="main__table-text main__table-text--rate"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
																<path d="M22,9.67A1,1,0,0,0,21.14,9l-5.69-.83L12.9,3a1,1,0,0,0-1.8,0L8.55,8.16,2.86,9a1,1,0,0,0-.81.68,1,1,0,0,0,.25,1l4.13,4-1,5.68A1,1,0,0,0,6.9,21.44L12,18.77l5.1,2.67a.93.93,0,0,0,.46.12,1,1,0,0,0,.59-.19,1,1,0,0,0,.4-1l-1-5.68,4.13-4A1,1,0,0,0,22,9.67Zm-6.15,4a1,1,0,0,0-.29.88l.72,4.2-3.76-2a1.06,1.06,0,0,0-.94,0l-3.76,2,.72-4.2a1,1,0,0,0-.29-.88l-3-3,4.21-.61a1,1,0,0,0,.76-.55L12,5.7l1.88,3.82a1,1,0,0,0,.76.55l4.21.61Z" />
															</svg> <?php echo $review; ?></div>
													</td>
													<td>
													...
													<div id="modal-view<?php echo $row[0]; ?>" class="zoom-anim-dialog mfp-hide modal modal--view">
														<div class="reviews__autor">
															...
															<span class="reviews__time"><?php echo $row[4]; ?> by
