...
<!--			</li>-->
			<li class="sidebar__nav-item">
				<a href="./index.php" class="sidebar__nav-link sidebar__nav-link--active"><i class="side_icon feather icon-grid"></i> <span>Catalog</span></a>
			</li>
<!--			<li class="sidebar__nav-item">-->
							...
							<form action="catalog" class="main__title-form">
								...
								<button type="submit">
									<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
										<circle cx="8.25998" cy="8.25995" r="7.48191" stroke="#4a875c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></circle>
										<path d="M13.4637 13.8523L16.3971 16.778" stroke="#4a875c" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
									</svg>
								</button>
							</form>
						</div>
					...
					<div class="main__table-wrap">
						...
						<table id="datatbl" class="main__table">
							...
							<tbody>
								...
								?>
									<script>
										document.getElementById('totals').innerHTML = "<?php echo number_format($tot); ?> Total";
									</script>
									<?php
										...
										<tr>
											...
											<td>
												<div class="main__table-btns">
													<a href="#modal-status<?php echo $row[0]; ?>" class="main__table-btn main__table-btn--<?php if ($row[16] == "Visible") {
																																				print 'view';
																																			} else {
																																				print 'banned';
																																			} ?> open-modal">
