						...
						<div class="row" id="app_frm">
							<div class="col-12 col-xl-6">
								<div class="sign__group">
									<input type="text" id="first-name" class="sign__input txt-cap" placeholder="Name">
								</div>
							</div>

							<div class="col-12 col-xl-6">
								<div class="sign__group">
									<input type="email" id="email" class="sign__input" placeholder="Email">
								</div>
							</div>

							<div class="col-12">
								<div class="sign__group">
									<input type="text" id="subject" class="sign__input txt-cap" placeholder="Subject">
								</div>
							</div>

							<div class="col-12">
								<div class="sign__group">
									<textarea class="sign__textarea" id="message" placeholder="Type your message"></textarea>
								</div>
							</div>
