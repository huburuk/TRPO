            ...
            ?>
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                  <div class="card">
                    ...
                    <a href="item/<?php echo $row[2]; ?>/<?php echo $item_title; ?>"><button class="card__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div class="col-12">
          <div class="catalog__paginator-wrap">
            ...
            <ul class="catalog__paginator">
              ...
              ?><script>
                  document.getElementById('showing').innerHTML = "Showing <?php echo $current; ?> to <?php echo $showing; ?> of <?php echo number_format($rec); ?>";
                </script><?php
