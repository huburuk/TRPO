				...
				<div class="col-12">
					<div class="header__content">
						...
						<a href="./" class="header__logo">
							<img class="inner_logo" src="<?php echo $dir; ?>img/<?php echo AppLogo; ?>" alt="">
						</a>

						<ul class="header__nav">

	            <li class="header__nav-item">
	              <a class="header__nav-link" href="<?php echo $dir; ?>catalog" role="button">Catalog</a>
	            </li>
	            <li class="header__nav-item">
	              <a class="header__nav-link" href="<?php echo $dir; ?>pricing">Pricing plans</a>
	            </li>
	            <li class="header__nav-item">
	              <a class="header__nav-link" href="<?php echo $dir; ?>about">About Us</a>
	            </li>
	            <li class="header__nav-item">
					...
					<div class="row row--grid">
						...
						<div class="col-12 col-sm-6 col-xl-4">
							<div class="stats">
								...
								<p>Valid : <?php echo $expire_date; ?></p>
						...
						<div class="col-12 col-sm-6 col-xl-4">
							<div class="stats">
								...
								<p><a href="javascript:void(0);"><?php echo $my_comments; ?></a></p>
						...
						<div class="col-12 col-sm-6 col-xl-4">
							<div class="stats">
								...
								<p><a href="javascript:void(0);"><?php echo number_format($my_reviews); ?></a></p>
						...
						<div class="col-12 col-xl-12">
							...
							<div class="dashbox">
								<div class="dashbox__title">
									<h3><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8,11a1,1,0,1,0,1,1A1,1,0,0,0,8,11Zm4,0a1,1,0,1,0,1,1A1,1,0,0,0,12,11Zm4,0a1,1,0,1,0,1,1A1,1,0,0,0,16,11ZM12,2A10,10,0,0,0,2,12a9.89,9.89,0,0,0,2.26,6.33l-2,2a1,1,0,0,0-.21,1.09A1,1,0,0,0,3,22h9A10,10,0,0,0,12,2Zm0,18H5.41l.93-.93a1,1,0,0,0,.3-.71,1,1,0,0,0-.3-.7A8,8,0,1,1,12,20Z"></path></svg> Your Comments</h3>
								...
								<div class="dashbox__table-wrap dashbox__table-wrap--2">
									<table id="datatbl2" class="main__table main__table--dash">
										...
										<tbody>
											...
											$stmt = $conn->prepare("SELECT * FROM tbl_comments LEFT JOIN tbl_items ON tbl_comments.item = tbl_items.item_id WHERE tbl_comments.user = ? ORDER BY tbl_comments.id DESC");
											...
											foreach($result as $row)
											{
												...
												<tr>
													<td>
														<div class="main__table-text"><a target="_blank" href="item/<?php echo $row[9]; ?>/<?php echo $item_title; ?>"><?php echo $row[8];?></a></div>
													</td>
													<td>
													...
													<a onclick="return confirm('Are you sure you want to delete?');" href="core/delete_comment?node=<?php echo $row[0]; ?>" class="delete_link">
														Delete
													</a></div>
												</td>
												</tr>
								...
								<div class="dashbox__table-wrap dashbox__table-wrap--2">
									<table id="datatbl" class="main__table main__table--dash">
										...
										<tbody>
											...
											$stmt = $conn->prepare("SELECT * FROM tbl_reviews LEFT JOIN tbl_items ON tbl_reviews.item = tbl_items.item_id WHERE tbl_reviews.user = ? ORDER BY tbl_reviews.id DESC");
											$stmt->execute([$user_id]);
											$result = $stmt->fetchAll();
											...
											foreach($result as $row)
											{
												...
												<tr>
													...
													<td>
														<div class="main__table-text"><?php echo $row[16]; ?></div>
													</td>
													<td>
													...
													<td width="100">
														<div class="main__table-text">
													<a onclick="return confirm('Are you sure you want to delete?');" href="core/delete_review?node=<?php echo $row[0]; ?>" class="delete_link">
														Delete
													</a></div>
												</td>
												</tr>
